...
import com.wanli.com.multitypedemo.multi.prividers.FooterLoadMorePrivider;
...
class MultiTypeInstaller {
    static void start() {
        GlobalMultiTypePool.register(FooterLoadMoreBean.class, new FooterLoadMorePrivider()); //footer
    }
}
